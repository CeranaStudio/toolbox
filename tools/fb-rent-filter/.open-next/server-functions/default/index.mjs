...
var BuildId = "sgplj9wDy0mwxDc0P9qHj";
var HtmlPages = ["/404"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }], "dynamic": [{ "page": "/api/lists/[id]", "regex": "^/api/lists/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/lists/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/list/[id]", "regex": "^/list/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/list/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/analyze/route": "/api/analyze", "/api/lists/[id]/route": "/api/lists/[id]", "/api/lists/route": "/api/lists", "/page": "/", "/list/[id]/page": "/list/[id]" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/lists/[id]": {}, "/api/analyze": {}, "/api/lists": {} } };
