...
var BuildId = "cxvz9NI3T1Q17AaExPIWl";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }], "dynamic": [{ "page": "/api/lists/[id]", "regex": "^/api/lists/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/lists/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/lists/[id]/records", "regex": "^/api/lists/([^/]+?)/records(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/lists/(?<nxtPid>[^/]+?)/records(?:/)?$" }, { "page": "/list/[id]", "regex": "^/list/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/list/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/analyze/route": "/api/analyze", "/api/lists/route": "/api/lists", "/api/lists/[id]/records/route": "/api/lists/[id]/records", "/api/lists/[id]/route": "/api/lists/[id]", "/list/[id]/page": "/list/[id]", "/page": "/" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/analyze": {}, "/api/lists/[id]/records": {}, "/api/lists": {}, "/api/lists/[id]": {} } };
