...
`)}}}),c={};((e,t)=>{for(var n in t)u(e,n,{get:t[n],enumerable:!0})})(c,{getOptionalRequestContext:()=>g,getRequestContext:()=>E}),v.exports=p(u({},"__esModule",{value:!0}),c),x(3010);var f=((e,t,n)=>(n=e!=null?j(O(e)):{},p(!t&&e&&e.__esModule?n:u(n,"default",{value:e,enumerable:!0}),e)))(w()),q=Symbol.for("__cloudflare-request-context__");function g(){let e=_[q];if((process?.release?.name==="node"?"nodejs":"edge")=="nodejs")throw Error(f.default`
		...
		`);return e}function E(){let e=g();if(!e)throw process?.env?.NEXT_PHASE==="phase-production-build"?Error(f.default`
			...
			`):Error("Failed to retrieve the Cloudflare request context.");return e}},a.__chunk_3010=()=>{},a);export{N as __getNamedExports};
